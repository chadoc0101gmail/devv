...
#                 st.image("./photo/fangniaoci1.jpg")       
            if choose == "防鸟挡板":
            ...
            if choose == "防鸟拉线":   
                st.info('防鸟拉线是利用铁丝或钢绞线在直线杆塔横担上，利用地线支架作为固定点，制成“V”或“X”形状拉线，阻止鸟类在横担中部停留，从而达到防鸟效果的一种防鸟装置，如图 8.43 所示。')         st.info('性能特点:制作简单，安装方便，综合防鸟效果较好。')
