...
class YOLO(object):
    ...
    def detect_image(self, image, crop = False):
        ...
        Measure = {'HG'   : '防鸟刺，防鸟挡板，防鸟盒，防鸟针板，防鸟罩，防鸟护套，防鸟拉线，人工鸟巢，人工栖鸟平台，旋转式风车、反光镜等惊鸟装置，声、光、电等驱鸟装置', 
                   'DFBG' : '防鸟刺，防鸟挡板，防鸟盒，防鸟针板，防鸟罩，防鸟护套，防鸟拉线，人工鸟巢，人工栖鸟平台，旋转式风车、反光镜等惊鸟装置，声、光、电等驱鸟装置', 
                   ...
                   'HS'   : '防鸟刺，防鸟挡板，防鸟盒，防鸟针板，防鸟罩，防鸟护套，防鸟拉线，人工鸟巢，人工栖鸟平台，旋转式风车、反光镜等惊鸟装置，声、光、电等驱鸟装置', 
        ...
        with torch.no_grad():
            ...
            #此处存在循环
            top_label_Number = sizeof(top_label) / sizeof(top_label[0])
    ...
    ## 表格 ##
        ...
        df.iloc[0,4] = f'<a target="_blank">{HarmRank[predicted_class]}</a>'
        df.iloc[0,5] = f'<a target="_blank">{Measure[predicted_class]}</a>'
